...
let publicationCollection = collection(db, "publications");
...
export default function Dashboard() {
	...
	async function handleSubmit() {
		...
		await addDoc(publicationCollection, {
			title: title,
			details: details,
		});
	...
	if (user) {
		return (<div className="flex flex-col items-center gap-[10px]">
			...
			<Button onClick={handleSubmit} variant="outlined">Create Publication</Button>
